@extends('layouts.app', ['page' => __('Compras'), 'pageSlug' => 'purchases'])
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <a class="btn btn-primary float-right" href="{{ route('purchases.create') }}">
                    Nuevo
                </a>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered dataTable no-footer" id="dataTableBuilder" width="100%" role="grid" aria-describedby="dataTableBuilder_info" style="width: 100%;">
                <thead>
                    <tr role="row">
                        ...
                        <th title="Nombre" class="sorting_desc" tabindex="0" aria-controls="dataTableBuilder" rowspan="1" colspan="1" aria-sort="descending" aria-label="Nombre: activate to sort column ascending" style="width: 316px;">FECHA</th>
